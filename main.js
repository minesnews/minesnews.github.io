...
function CardTextFormatting(CardText) {
	...
	CardText = CardText.replace(/(Станит)/gi,"<span class=\"CardCentreKeyWordText\" onmousemove=\"ShowKeywordTooltip(1,\'Станит\');\" onmouseout=\"ShowKeywordTooltip(0,0);\">Стан</span>");
