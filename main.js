...
function CardTextFormatting(CardText) {
	...
	CardText = CardText.replace(/(Стан)/gi,"<span class=\"CardCentreKeyWordText\" onmousemove=\"ShowKeywordTooltip(1,\'Станит\');\" onmouseout=\"ShowKeywordTooltip(0,0);\">Станит</span>");
