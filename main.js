...
function CardTextFormatting(CardText) {
	...
	CardText = CardText.replace(/(Станит)/gi,"<span class=\"CardCentreKeyWordText\" onmousemove=\"ShowKeywordTooltip(1,\'Стант\');\" onmouseout=\"ShowKeywordTooltip(0,0);\">Станит</span>");
